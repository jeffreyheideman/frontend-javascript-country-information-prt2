...
async function fetchCountry() {
    try {
        const response = await (0, _axiosDefault.default).get(`${ENDPOINT}${inputField.value}${FIELDS}`);
...
function displayCurrencies(currencies) {
    if (currencies.length === 1) return `and you can pay with ${currencies[0].name}'s`;
    else if (currencies.length === 2) return `and you can pay with ${currencies[0].name}'s and ${currencies[1].name}'s`;
}
...
var Buffer = require("79a06f8eb691620c").Buffer;
"use strict";
/**
...
},{"79a06f8eb691620c":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("bd555225a9637e2e");
var ieee754 = require("aa26ec2fcb48c177");
...
},{"bd555225a9637e2e":"eIiSV","aa26ec2fcb48c177":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
